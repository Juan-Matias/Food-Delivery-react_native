...
import { empyCart } from '../slices/cartSlice.js';
  ...
  return (
    <View className="flex-1">
      <MapView
        ...
        className="flex-1"
        mapType='satelliteFlyover'  // Cambiar a 'satellite', 'terrain' o 'standard' según prefieras
        ...
        className="p-2 flex-row justify-between items-center rounded-full my-5 mx-2">
            <View className="p-1 rounded-full"
                style={{backgroundColor:'rgb(255,255,255,0.4)'}}>
                    <Image className="h-16 w-16 rounded-full" source={require('../assets/images/deliveryPeople.png')}/>
            </View>
            <View className="flex-1 ml-3">
                <Text className="text-lg font-bold text-white"> Matias Ponce</Text>
